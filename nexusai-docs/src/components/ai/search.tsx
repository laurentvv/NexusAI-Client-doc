  ...
  return (
    ...
    >
      <div className="px-3 py-2 flex-1">
        <p className="text-sm font-medium mb-2">NexusAI Assistant</p>
        <p className="text-xs text-fd-muted-foreground">
          AI assistant indexing NexusAI-Client documentation.
        </p>
      </div>
...
export function AISearchInput(props: ComponentProps<'form'>) {
  ...
  return (
    <form {...props} className={cn('flex items-start pe-2', props.className)} onSubmit={onStart}>
      <Input
        value={input}
        placeholder={isLoading ? 'Searching & answering...' : 'Ask a question about NexusAI-Client'}
        autoFocus
        className="p-3"
        ...
        return (
          ...
          >
            ...
            {call.state === 'output-error' || call.state === 'output-denied' ? (
              ...
              <p>{!call.output ? 'Searching documentation…' : `${call.output.length} search results`}</p>
            )}
          </div>
        );
      })}
